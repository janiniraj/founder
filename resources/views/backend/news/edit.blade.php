...
@section('content')
    {{ html()->modelForm($news, 'PATCH', route('admin.news.update', $news->id))->class('form-horizontal')->acceptsFiles()->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.news.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            @if(isset($news->image) && $news->image)
                                <img id="imagedisplay" src="{{ url('/').'/img/news/'.$news->image }}" />
                            @else
