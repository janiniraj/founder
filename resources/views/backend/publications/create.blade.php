...
@section('content')
    {{ html()->form('POST', route('admin.publications.store'))->class('form-horizontal')->acceptsFiles()->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.publications.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
